...
<div class="container">
    ...
    <h3 class="two"> with JobFaser</h3>
       <h3 >connecting you to top employers and opportunities</p></h3>
        <input type="text" class="subscribe_barre" placeholder="email address or phone number"> <button>subscribe</button></div>
</div>
